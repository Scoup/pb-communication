...
LINT=false
LINT_CHECKS=""
SUPPORTED_LANGUAGES=("go" "ruby" "csharp" "java" "python" "objc" "gogo" "php" "node" "web", "typescript")
EXTRA_INCLUDES=""
OUT_DIR=""
GO_SOURCE_RELATIVE=""
...
if [ $PLUGIN_LANG == 'typescript' ] ; then
    PLUGIN_LANG='/usr/lib/node_modules/ts-protoc-gen/bin/protoc-gen-ts'
fi
...
:$OUT_DIR"
    ...
    "web")
        ...
        ;;
    "typescript")
        GEN_STRING="--js_out=import_style=commonjs,binary:$OUT_DIR --ts_out=service=true:$OUT_DIR --plugin=protoc-gen-ts=$PLUGIN_LANG"
        ;;
    *)
...
echo "GEN_STRING $GEN_STRING"
echo "LINT_STRING $LINT_STRING"
